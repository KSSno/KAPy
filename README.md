...
# Getting started
Source conda by `source /modules/centos7/conda/prod_04_2021/etc/profile.d/conda.sh`. Activate environment for KAPy by going to `/lustre/storeC-ext/users/klimakverna/development/conda/KAPy` and run `conda activate KAPy`, or just run `conda activate /lustre/storeC-ext/users/klimakverna/development/conda/KAPy`.
